...
declare function RadioGroup<Id = string, Context = any>({ items, testid, onSelect, selectedItem, customClassName, isDisabled }: RadioGroupProps<Id, Context>): import("react/jsx-runtime").JSX.Element;
