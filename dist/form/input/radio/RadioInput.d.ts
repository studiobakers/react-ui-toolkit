...
declare function RadioInput<Id = string, Context = any>({ testid, item, onSelect, isSelected, isDisabled }: RadioInputProps<Id, Context>): import("react/jsx-runtime").JSX.Element;
