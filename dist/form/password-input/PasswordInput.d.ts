...
declare function PasswordInput({ testid, name, value, onChange, hasError, placeholder, customClassName, hideIcon, revealIcon }: PasswordInputProps): import("react/jsx-runtime").JSX.Element;
