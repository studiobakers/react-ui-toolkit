...
declare function Toggle({ children, onToggle, selectedItems, canSelectMultiple, position, isDisabled, customClassName }: ToggleProps): import("react/jsx-runtime").JSX.Element;
