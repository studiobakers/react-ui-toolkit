...
import React, {ForwardedRef, Ref, useEffect, useLayoutEffect, useRef} from "react";
...
const SelectItem = React.forwardRef<SelectItemElement, SelectItemProps>(
  ...
  function SelectItemComponent<T extends Option = Option>(
    ...
    const innerRef = useRef<SelectItemElement | null>(null);
    const optionRef = useCombinedRefs(ref || null, innerRef);
